...
** Answer the Pedagogy questionnaire
   The file =q-and-a.md= contains list of questions and
   answering them will help build the experiment with strong
   pedagogy principles.  Refer to [[merge-sort]]'s [[answers]]. 
